...
A fast-paced, retro-arcade survival game built entirely with HTML5 Canvas, CSS, and Vanilla JavaScript. Dodge oncoming traffic, collect gold datacubes, and survive as long as you can as the speed continuously increases! 

Play it live here: https://neon-highway.waliulawaltaha.com
...
* **Mouse:** Click and hold inside the game screen, then drag left or right.
* **Mobile / Touch:** Tap and hold the screen, then drag your finger left or right.
* **Pause:** Press `P`, `ESC`, or click the `||` button on the screen.

## 👨‍💻 Credits
Created by **[Waliul Awal Taha](http://www.waliulawaltaha.com)**.
